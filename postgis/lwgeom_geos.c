...
/**
	@example pointonsurface - {@link #pointonsurface} SELECT ST_PointOnSurface('POLYGON((0 0, 10 0, 10 10, 0
10, 0 0))');
*/
...
{
	PG_RETURN_DATUM(
	    CallerFInfoFunctionCall2(contains, fcinfo->flinfo, InvalidOid, PG_GETARG_DATUM(1), PG_GETARG_DATUM(0)));
}
