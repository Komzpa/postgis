...
typedef struct LWT_BE_CALLBACKS_T
{
   ...
   */
  LWT_ISO_EDGE *(
      *getEdgeByFace)(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *ids, int *numelems, int fields, const GBOX *box);
   ...
   */
  LWT_ISO_NODE *(
      *getNodeByFace)(const LWT_BE_TOPOLOGY *topo, const LWT_ELEMID *faces, int *numelems, int fields, const GBOX *box);
