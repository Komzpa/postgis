...
{
	cu_wkb_in(
	    "SRID=14;MULTIPOLYGON(((0 0 0,0 1 0,1 1 0,1 0 0,0 0 0)),((-1 -1 0,-1 2 0,2 2 0,2 -1 0,-1 -1 0),(0 0 0,0 1 "
	    "0,1 1 0,1 0 0,0 0 0)))");
	CU_ASSERT_STRING_EQUAL(hex_a, hex_b);
	// printf("old: %s\nnew: %s\n",hex_a, hex_b);
}
...
test_wkb_in_collection(void)
{
	...
	cu_wkb_in(
	    "SRID=14;GEOMETRYCOLLECTION(MULTIPOLYGON(((0 0 0,0 1 0,1 1 0,1 0 0,0 0 0))),POLYGON((0 0 0,0 1 0,1 1 0,1 0 "
	    "0,0 0 0)),POINT(1 1 1),LINESTRING(0 0 0, 1 1 1))");
	CU_ASSERT_STRING_EQUAL(hex_a, hex_b);
}
...
{
	cu_wkb_in(
	    "COMPOUNDCURVE(CIRCULARSTRING(0 0 0, 0.26794919243112270647255365849413 1 3, "
	    "0.5857864376269049511983112757903 1.4142135623730950488016887242097 1),(0.5857864376269049511983112757903 "
	    "1.4142135623730950488016887242097 1,2 0 0,0 0 0))");
	CU_ASSERT_STRING_EQUAL(hex_a, hex_b);
}
...
{
	cu_wkb_in(
	    "CURVEPOLYGON(CIRCULARSTRING(-2 0 0 0,-1 -1 1 2,0 0 2 4,1 -1 3 6,2 0 4 8,0 2 2 4,-2 0 0 0),(-1 0 1 2,0 0.5 "
	    "2 4,1 0 3 6,0 1 3 4,-1 0 1 2))");
	CU_ASSERT_STRING_EQUAL(hex_a, hex_b);
}
...
test_wkb_in_malformed(void)
{
	...
	cu_wkb_malformed_in(
	    "0106000040020000000104000040010000000101000040000000000000000000000000000000000000000000000000010100004000"
	    "0000000000F03F000000000000F03F000000000000F03F");
	cu_wkb_malformed_in(
	    "0105000040020000000104000040010000000101000040000000000000000000000000000000000000000000000000010100004000"
	    "0000000000F03F000000000000F03F000000000000F03F");
	cu_wkb_malformed_in(
	    "0104000040020000000104000040010000000101000040000000000000000000000000000000000000000000000000010100004000"
	    "0000000000F03F000000000000F03F000000000000F03F");
	cu_wkb_malformed_in(
	    "0103000040020000000104000040010000000101000040000000000000000000000000000000000000000000000000010100004000"
	    "0000000000F03F000000000000F03F000000000000F03F");

	/* See http://trac.osgeo.org/postgis/ticket/168 */
	cu_wkb_malformed_in(
	    "01060000C00100000001030000C00100000003000000E3D9107E234F5041A3DB66BC97A30F4122ACEF440DAF9440FFFFFFFFFFFFEF"
	    "FFE3D9107E234F5041A3DB66BC97A30F4122ACEF440DAF9440FFFFFFFFFFFFEFFFE3D9107E234F5041A3DB66BC97A30F4122ACEF44"
	    "0DAF9440FFFFFFFFFFFFEFFF");
}
