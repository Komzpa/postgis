...
test_twkb_out_multipolygon(void)
{
    ...
    CU_ASSERT_STRING_EQUAL(s,
                           "060801020105000000000200020000000100010000020501010000060006000000050005000005020200000"
                           "200020000000100010000");
}

static void
test_twkb_out_collection(void)
{
