...
{
    /* Linestring */
    do_geojson_test("LINESTRING(0 1,2 3,4 5)", "{\"type\":\"LineString\",\"coordinates\":[[0,1],[2,3],[4,5]]}", NULL);
    ...
    do_geojson_test(
        "MULTIPOLYGON(((4 0,0 -4,-4 0,0 4,4 0),(2 0,0 2,-2 0,0 -2,2 0)),((24 0,20 -4,16 0,20 4,24 0),(22 0,20 2,18 "
        "0,20 -2,22 0)),((44 0,40 -4,36 0,40 4,44 0),(42 0,40 2,38 0,40 -2,42 0)))",
        "{'type':'MultiPolygon','coordinates':[[[[4,0],[0,-4],[-4,0],[0,4],[4,0]],[[2,0],[0,2],[-2,0],[0,-2],[2,0]]"
        "],[[[24,0],[20,-4],[16,0],[20,4],[24,0]],[[22,0],[20,2],[18,0],[20,-2],[22,0]]],[[[44,0],[40,-4],[36,0],["
        "40,4],[44,0]],[[42,0],[40,2],[38,0],[40,-2],[42,0]]]]}",
        NULL);
