...
{
  do_grid_test(
      "POINT ZM (5.1423999999 5.1423999999 5.1423999999 5.1423999999)", "POINT(5.1424 5.1424 5.1424 5.1424)", 0.0001);
...
test_lwmpoint_from_lwgeom(void)
{
  ...
  do_fn_test(
      to_points, "MULTIPOINT M (10 40 1,40 30 2,20 20 3,30 10 4)", "MULTIPOINT M (10 40 1,40 30 2,20 20 3,30 10 4)");
  do_fn_test(to_points,
