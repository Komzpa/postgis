...
test_lwgeom_clip_by_rect(void)
{
	...
	/* Disjoint polygon */
	wkt =
	    "POLYGON((311017 4773762,311016 4773749,311006 4773744,310990 4773748,310980 4773758,310985 4773771,311003 "
	    "4773776,311017 4773762))";
	in = lwgeom_from_wkt(wkt, LW_PARSER_CHECK_NONE);
