...
test_lwgeom_make_valid(void)
{
  ...
  gin = lwgeom_from_wkt(
      "MULTIPOLYGON(((1725063 4819121, 1725104 4819067, 1725060 4819087, 1725064.14183882 "
      "4819094.70208557,1725064.13656044 4819094.70235069,1725064.14210359 4819094.70227252,1725064.14210362 "
      "4819094.70227252,1725064.13656043 4819094.70235069,1725055. 4819094, 1725055 4819094, 1725055 4819094, "
      "1725063 4819121)))",
  ...
  gin = lwgeom_from_hexwkb(
      "0106000020E6100000010000000103000000010000000A0000004B7DA956B99844C0DB0790FE8B4D1DC010BA74A9AF9444C049AFFC"
      "5B8C4D1DC03FC6CC690D9844C0DD67E5628C4D1DC07117B56B0D9844C0C80ABA67C45E1DC0839166ABAF9444C0387D4568C45E1DC0"
      "10BA74A9AF9444C049AFFC5B8C4D1DC040C3CD74169444C0362EC0608C4D1DC07C1A3B77169444C0DC3ADB40B2641DC03AAE5F68B9"
      "9844C0242948DEB1641DC04B7DA956B99844C0DB0790FE8B4D1DC0",
      LW_PARSER_CHECK_NONE);
  CU_ASSERT(gin != NULL);
  ...
  */
  ...
  "GEOMETRYCOLLECTION(POINT(0 0),MULTIPOLYGON(((5 5,0 0,0 10,5 5)),((5 5,10 10,10 0,5 5))),LINESTRING(10 0,10
  10))");*/
  gexp = lwgeom_from_wkt(
      "GEOMETRYCOLLECTION(POINT(0 0),MULTIPOLYGON(((5 5,0 0,0 10,5 5)),((5 5,10 10,10 0,5 5))),LINESTRING(10 "
      "0,10 10))",
      LW_PARSER_CHECK_NONE);
  ...
  gin = lwgeom_from_wkt("MULTIPOINT(0 0,1 1,2 2)", LW_PARSER_CHECK_NONE);
  CU_ASSERT(gin != NULL);
  ...
  ewkt = lwgeom_to_ewkt(gout);
  /* printf("c = %s\n", ewkt); */
  CU_ASSERT_STRING_EQUAL(ewkt, "MULTIPOINT(0 0,1 1,2 2)");
  lwfree(ewkt);
  ...
  gin = lwgeom_from_hexwkb(
      "0103000000010000000400000000000000000024400000000000003640000000000000244000000000000040400000000000003440"
      "000000000000404000000000000034400000000000003640",
      LW_PARSER_CHECK_NONE);
  CU_ASSERT(gin != NULL);
  ...
  ewkt = lwgeom_to_ewkt(gout);
  /* printf("c = %s\n", ewkt); */
  CU_ASSERT_STRING_EQUAL(ewkt, "POLYGON((10 22,10 32,20 32,20 22,10 22))");
  lwfree(ewkt);
