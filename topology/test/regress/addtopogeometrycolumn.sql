...
create table test2023_topo."FeatureBeforeRename"(id integer);
do $$
declare
  feature_table regclass := 'test2023_topo."FeatureBeforeRename"'::regclass;
begin
  alter table test2023_topo."FeatureBeforeRename" rename to "FeatureAfterRename";
  perform topology.addtopogeometrycolumn('tt',feature_table,'ticket2023_oid','POLYGON');
end
$$;
reset search_path;
...
drop table test2023_topo."FeatureAfterRename";
